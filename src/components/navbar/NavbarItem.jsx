  ...
  return (
    <>
      <motion.li className="nav-item col-auto" {...animation} style={{cursor: "pointer"}}>
        <Link className="nav-link active text-center" to={redirect} smooth={true} offset={-70} duration={1000} data-bs-toggle="collapse" data-bs-target=".navbar-collapse.show" onClick={() => external && window.open(redirect, "_blank")}>
