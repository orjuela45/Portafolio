export const academicAndExperienceInformation = [
  {
    type: "education",
...
export const skillsInformation = {
  ...
  personal: [
    ...
    {
      label: "lbl-criticalThinking",
      id: "criticalThinking",
      icon: "./thought.png"
    },
    {
      label: "lbl-preparedForChange",
      id: "preparedForChange",
      icon: "./change.png"
    },
    {
      label: "lbl-proactive",
    ...
    {
      label: "lbl-punctuality",
      id: "punctuality",
      icon: "./punctuality.png"
    },
    {
      label: "lbl-respectful",
      id: "respectful",
      icon: "./respect.png"
    },
    {
      label: "lbl-responsible",
      id: "responsible",
      icon: "./responsibility.png"
    },
    {
      label: "lbl-problemSolver",
      id: "problemSolver",
